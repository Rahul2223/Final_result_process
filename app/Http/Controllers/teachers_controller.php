...
$teacherinfo->password=$request->password;
$teacherinfo->save();

return redirect('/teacherlist')->with('message', 'teacherinfo add successfully');
}
...
public function update(Request $request)
{
   ...
   $updated=Teacherinfo::where('id','=',$ID)->update(array('name'=>$request->fullname,'fathers_name'=>$request->fname,'mothers_name'=>$request->mname,'subject'=>$request->subject,'contact'=>$request->contact,'address'=>$request->address,'password'=>$request->password));

              ...
              <form role="form">
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <label>Roll</label>
                      <input type="text" name="class roll" id="class_roll" class="form-control input-sm" placeholder="roll_number">
                    </div>
                  </div>
                ...
                <a class="btn btn-primary"  href="{{('studentInfo')}}" role="button">Add</a>

 ...
 <br>
     ...
     <div class="col-md-12">
        <a class="btn btn-success" href="">Show Marks</a>
            ...
            {!!Form::open(['action'=>'markentry_controller@submitmarksanual'])!!}
   ...
   <div style="border-bottom:1px solid #ccc; padding: 2px; margin-bottom: 10px;">
      <h2>Student of <b>Class</b> <?php echo $class?>,<b> sub: </b><?php echo $subject;?>, <b>Exam:</b>Anual</h2>
      </div>
  ...
  <table class="table table-bordered" style="background: #fff ; width: 50%">
    ...
    <tbody>
    <?php foreach($anualdata as $value) { ?>
    <tr>
